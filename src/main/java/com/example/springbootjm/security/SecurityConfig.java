...
import com.example.springbootjm.security.handler.LoginSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private final com.example.springbootjm.security.handler.LoginSuccessHandler LoginSuccessHandler; // класс, в котором описана логика перенаправления пользователей по ролям
